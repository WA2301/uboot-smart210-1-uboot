...
#  endif
	...
	i->__promptme = 1;
	if (i->promptmode == 1) {
		n = readline(CONFIG_SYS_PROMPT);/* WA2301:Run here print "[Smart210#] " */
	} else {
...
/* WA2301:Waiting in this function,when get command,  Run again */
...
#endif
{
	...
	/* WA2301:Not here when waiting for user input */
	return rcode;
}
